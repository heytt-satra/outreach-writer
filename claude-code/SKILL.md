...
Once you have enough to work with, write the message. Do not wait for perfect information.
...
- Two to three specific proof points
- Soft close with zero pressure
...
Frame across four angles:
- Technical depth (what they built and shipped)
- Customer understanding (support, feedback, user behaviour)
- Product thinking (what decisions they influenced)
- Business awareness (what outcomes they drove)

Show what they built, not just where they worked. Results and shipped things beat job titles every time.

Do not say "I am looking for a job." Say what you can do for the company, then let them connect the dots.
...
The best outreach makes it so easy to say yes that saying no feels like the mistake. Give something real before asking for anything.

The message is not about the sender. It is about making the recipient feel like the sender is the obvious next step.
